...
changestatus=function($status,$id){
 ...
 getsearch=function(){
   ...
   window.location.href='<?php echo Configure::read('siteUrl');?>admin/users/index/'+$fdate+'/'+$tdate+'/'+$sby+'/'+$key;   
   }
...
$(function() {
 ...
 <div class="kt-subheader  kt-grid__item" id="kt_subheader">
	...
	<a href="<?php echo $this->Html->url('/admin/users/add/'.$rsposition['referralcode'],true);?>"><strong><?php  echo h($rsposition['referralcode']);?></strong></a><br/>	     
		...
		<select class="formcontrol" name="status" onchange="changestatus(this.value,<?php echo h($user['User']['id']); ?>);">
