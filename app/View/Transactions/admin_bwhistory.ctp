...
getserach=function(){
   ...
   window.location.href='<?php echo Configure::read('siteUrl');?>admin/transactions/bwhistory/'+$fdate+'/'+$tdate+'/'+$username; 
}
...
<a href="<?php echo $this->Html->url('/admin/transactions/bw_summary_history',true);?>" class="btn btn-label-primary">BW Summary History</a>
	...
	<div class="row alert alert-light">
	 ...
	 <div class="col-md-2 col-12">
		...
		<div class="row">			
			...
			<th width="23%" ><?php echo $this->Paginator->sort('user_id'); ?></th>	
			<th width="16%" ><?php echo $this->Paginator->sort('positionreffid','Position Referral ID'); ?></th>	
			<th width="11%" ><?php echo $this->Paginator->sort('amount'); ?></th>	
			<th width="10%"><?php echo $this->Paginator->sort('bonus_from'); ?></th>			
			<th width="23%"><?php echo $this->Paginator->sort('remarks'); ?></th>	
			<th width="11%" ><?php echo $this->Paginator->sort('created'); ?></th>
	</tr>
	</thead>
	<tbody>
		...
		<?php foreach($results as $k=>$result): ?>		
				  ...
				  <tr>
					...
					<td><?php echo $result['Transaction']['bonus_from']; ?></td>  								
