...
getserach=function(){
   ...
   window.location.href='<?php echo Configure::read('siteUrl');?>admin/transactions/upline_commission/'+$fdate+'/'+$tdate+'/'+$username; 
}
					...
					<div class="kt-portlet__head">
						<div class="kt-portlet__head-label">
							<h3 class="kt-portlet__head-title">
								View Upline Commission
							</h3>
						</div>
						<div class="kt-portlet__head-label">
						<div class="kt-subheader__toolbar">
						 <div class="kt-subheader__wrapper">
<a href="<?php echo $this->Html->url('/admin/transactions/uc_summary_history',true);?>" class="btn btn-label-primary">Upline Commission Summary History</a>
</div>
						 </div>
						</div>
					</div>
			...
			<th width="25%" ><?php echo $this->Paginator->sort('user_id'); ?></th>	
			<th width="15%" ><?php echo $this->Paginator->sort('positionreffid','Position Referral ID'); ?></th>
			<th width="10%" ><?php echo $this->Paginator->sort('amount'); ?></th>	
			<th width="13%"><?php echo $this->Paginator->sort('bonus_from'); ?></th>					
			<th width="19%"><?php echo $this->Paginator->sort('remarks'); ?></th>	
			<th width="12%" ><?php echo $this->Paginator->sort('created'); ?></th>
	</tr>
	</thead>
	<tbody>
