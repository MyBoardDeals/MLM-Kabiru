...
<script>
 getsearch=function(){
   ...
   window.location.href='<?php echo Configure::read('siteUrl');?>admin/invoices/completed/'+$fdate+'/'+$tdate+'/'+$key;   
   }
	 ...
	 <div class="col-2">
		...
		<div class="row">			
					...
					<div class="kt-portlet__head">
						<div class="kt-portlet__head-label">
							<h3 class="kt-portlet__head-title">
								View Completed Subscription History
							</h3>
						</div>
					</div>
		   ...
		   <th width="22%"><?php echo $this->Paginator->sort('user_id'); ?></th>
			...
			<th width="13%"><?php echo $this->Paginator->sort('payment_date'); ?></th>					
				
			<?php /*?><th width="8%"><a>Action</a></th>	<?php */?>
      </tr>	
	  </thead>
	  <tbody>
