...
<script>
 ...
 getsearch=function(){
   ...
   window.location.href='<?php echo Configure::read('siteUrl');?>admin/invoices/index/'+$fdate+'/'+$tdate+'/'+$key;   
   }
...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								...
								<?php /*?><div class="kt-subheader__toolbar">
	...
	<div class="kt-container kt-container--fluid  kt-grid__item kt-grid__item--fluid">		
	 ...
	 <div class="col-2">
		...
		<div class="row">			
		   ...
		   <th width="21%"><?php echo $this->Paginator->sort('user_id'); ?></th>
			<th width="13%"><?php echo $this->Paginator->sort('amount','Amount'); ?></th>		
			<th width="32%"><?php echo $this->Paginator->sort('remarks'); ?></th>		
			<th width="13%"><?php echo $this->Paginator->sort('type','Is Re-entry?'); ?></th>					
   ...
   <?php if(count($results)>0): ?>		  	
	...
	<tr>
		 ...
		 <td ><?php echo date('m/d/Y H:i:s',strtotime($result['Invoice']['created'])); ?></td>
